...
let audioAcerto = document.getElementById('audioAcertoid');
let audioErro = document.getElementById('audioErroid');
let audioTermino = document.getElementById('audioTerminoid');
